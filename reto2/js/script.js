window.onload = function()
{
    ...
    */
    ...
    {
      denominador = Math.pow(10,  String(datosDecimal.decimal).length);
      var num = String(datosDecimal.entero) + "." + String(datosDecimal.decimal);
      numerador = num * denominador ;
        /*
        Entregar el valor fraccionario de la forma numerador/denominador
        */
        console.log(simplificaFraccionario(numerador + "/" + denominador));
